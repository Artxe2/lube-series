 ...
 */
"use strict"
const rule = require("../rules/id-match")
...
/** @type {{ valid:  RuleTester.ValidTestCase[], invalid: RuleTester.InvalidTestCase[] }} */
const test_target = {
	valid: [],
	invalid: []
}
const { valid, invalid } = test_target
...
rule_tester.run("id-match", rule, test_target)